...
public class Changelog extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Pattern p = Pattern.compile("([a-f0-9]{7})\\s_(.*)_\\s\\[(.*)\\]"); //(?dms)
...
//            text = getString(R.string.changelog_crdroid_error);
	...
	SpannableStringBuilder sb = new SpannableStringBuilder(data);
        ...
        while (m.find()){
          ...
          sb.setSpan(new StyleSpan(android.graphics.Typeface.BOLD),m.start(1),m.end(1),Spannable.SPAN_INCLUSIVE_INCLUSIVE);
